...
class SimpleHolisticStatsScreen extends StatefulWidget {
  const SimpleHolisticStatsScreen({super.key});

  @override
  State<SimpleHolisticStatsScreen> createState() => _SimpleHolisticStatsScreenState();
}

class _SimpleHolisticStatsScreenState extends State<SimpleHolisticStatsScreen> {
  ...
  void initState() {
    super.initState();
    statsBox = Hive.box('simpleHolisticStats');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('심플 홀리스틱 릴리징 통계'),
      ),
      body: Column(
        children: [
          TableCalendar(
